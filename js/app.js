/**
 * Create — Digital atelier of creativity & flow
...
(function () {
    ...
    if ($("#book-count")) {
      $("#book-count").textContent =
        nShelves === 1
          ...
          : `${books.length} volumes · ${nShelves} studios`;
    }
  ...
  function buildListenScript(book, mode) {
    ...
    if (mode === "full") {
      script.push({
        label: "Closing",
        text: `That concludes the guided reading of ${book.title}. Return to the atelier when you are ready for the next volume.`,
      });
    }
  ...
  function openModal(book) {
    ...
    modal.innerHTML = `
      <div class="modal-hero">
        ...
        <button type="button" class="modal-close" aria-label="Back to atelier">×</button>
      ...
      <div class="modal-body">
        ...
        <p class="expand-hint">Tap an insight for a full hip-hop song about the teaching — chorus, verses, modern-day apply, then a practice move.</p>
        <ol class="meat-list">
          ${insights
            .map((insight, i) => {
